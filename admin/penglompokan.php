...
// Ambil semua data dari tabel pengolahan_sampah
$result = $conn->query("SELECT * FROM pengolahan_sampah ORDER BY id DESC");
    ...
    <div class="container">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="post">
                ...
                <a href="detail_artikel1.php?id=<?php echo $row['id']; ?>" class="read-more">Baca Selengkapnya</a>
            </div>
        <?php endwhile; ?>
    </div>
